...
public class WechatConfig {
     ...
     * appId
     */
    public static final String VxAppId = "wxb840ba909e1b384c";

    /**
     * 你的微信的密钥
     * appSecret
     */
    public static final String VxAppSecret = "17a0ab6ed14addd9116ccfc3e1f587c0";
    ...
    static {
        userList.add(getUser(
                "oQXD66dkbMAlJtoC4dHXQ9OScIUg1", //扫码关注你的测试号以后，测试平台会出现TA的微信号
                "E5LsLUNp3qXHndnd79ID23dKITWSecr8v8LHxkM9vY0", //要给这个人发送的模板ID
                "小胖宝", //咋称呼这个人
                "黑龙江省黑河市爱辉区", //这个人的详细地址
                "黑河", //这个人在的城市
                new BirthDay(1999,2,15,true,false,"小胖宝生日快乐！！"),
                new BirthDay(1999,8,11,false,false,"生日快乐哦~~"),
                new BirthDay(2023,5,26,false,true),
                new BirthDay(2023,5,26,false,true)
        ));

        userList.add(getUser(
                "oQXD66YIVP4zB8RBsTSygfNZlbhM", //扫码关注你的测试号以后，测试平台会出现TA的微信号
                "E5LsLUNp3qXHndnd79ID23dKITWSecr8v8LHxkM9vY0", //要给这个人发送的模板ID
                "小胖宝", //咋称呼这个人
                "黑龙江省黑河市爱辉区", //这个人的详细地址
                "黑河", //这个人在的城市
